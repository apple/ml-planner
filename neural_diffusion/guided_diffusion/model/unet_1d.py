...
from guided_diffusion.model import register_model, DiffusionModelBase
...
class UNetModel(DiffusionModelBase):
    """
        ...
        **unused,
        ...
        if self.num_classes is not None:
            ...
            if self.cond_feature:
                self.non_emb = nn.Parameter(th.randn(self.num_classes), requires_grad=True)
        ...
        #  if (self.image_size // ds) <= maximum_atten_res else nn.Identity(),  # @Jiatao
        self._feature_size += ch
